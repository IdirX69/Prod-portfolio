/*! For license information please see main.49d30e6f.js.LICENSE.txt */
!(function () {
  var e = {
      998: function (e, t, n) {
        "use strict";
      ...
      463: function (e, t, n) {
        ...
        function Xi(e) {
          ...
          function m(a, l, u, s) {
            ...
            for (
              var f = (c = null), h = l, m = (l = 0), y = null, g = u.next();
              null !== h && !g.done;
              m++, g = u.next()
            ) {
            ...
            if (g.done) return n(a, h), ai && Za(a, m), c;
            if (null === h) {
            ...
            for (h = r(a, h); !g.done; m++, g = u.next())
              null !== (g = v(h, a, m, g.value, s)) &&
                (e &&
                  null !== g.alternate &&
        ...
        function Bo(e, t, n, r) {
          ...
          (ho.flags |= e), (a.memoizedState = Io(1 | t, n, i, r));
        }
        function Wo(e, t) {
        ...
        function jl(e, t, n, r, a) {
          ...
          if ((Ei(t, a), null === t.stateNode))
            ...
            l !== f || d !== v || Ra.current || Li
              ? ("function" === typeof p &&
                  (zi(t, n, p, r), (v = t.memoizedState)),
                (s = Li || Bi(t, n, s, r, d, v, u) || !1)
                  ? (c ||
        ...
        function Ol(e, t, n, r, a) {
          return pi(), vi(a), (t.flags |= 256), wl(e, t, n, r), t.child;
        }
        var Nl,
          _l,
          Ml,
          ...
          if (null !== (o = e.memoizedState) && null !== (r = o.dehydrated))
            return (function (e, t, n, r, a, o, l) {
              ...
              if (((u = 0 !== (l & e.childLanes)), xl || u)) {
                ...
                return hs(), Il(e, t, l, (r = fl(Error(i(421)))));
              }
              return "$?" === a.data
                ? ((t.flags |= 128),
                  (t.child = e.child),
        ...
        function mu(e, t) {
          ...
          switch (e.tag) {
            ...
            case 15:
              ...
              break;
            case 1:
              hu(t, e), yu(e), 512 & r && null !== n && Jl(n, n.return);
              break;
            case 5:
              if (
                (hu(t, e),
          ...
          (t.unstable_scheduleCallback = function (e, a, i) {
            ...
            return (
              ...
              i > o
                ...
                : ((e.sortIndex = l), n(s, e), h || v || ((h = !0), _(k))),
              e
            );
          }),
    ...
    (function () {
      ...
      function D(t, n, r, a) {
        ...
        var v = {
          ...
          push: function (t, n) {
            ...
            s && d && d({ action: f, location: v.location });
          },
      ...
      function De(n) {
        ...
        return (function (n, r) {
          ...
          var v = a.pathname || "/",
            h = A(n, { pathname: "/" === c ? v : v.slice(c.length) || "/" }),
            m = Re(
              h &&
                h.map(function (e) {
                    ...
                    (0, Qe.jsxs)("ul", {
                      ...
                      children: [
                        ...
                        (0, Qe.jsx)(He, {
                          ...
                          children: (0, Qe.jsx)("li", { children: "projet 4" }),
                        }),
                      ],
                    }),
                  ],
      ...
      var pt = (0, t.createContext)(null),
        ...
        ht = vt ? t.useLayoutEffect : t.useEffect,
      ...
      function Dt(e) {
        ...
        var u = (0, t.forwardRef)(function (e, u) {
          var s = ct(
            ...
            v = o(e, c);
          if (!c && vt) {
            d.visualElement = yt(l, v, s, r);
            var h = (0, t.useContext)(mt).strict,
              m = (0, t.useContext)(_t);
            d.visualElement &&
        ...
        for (var d in t) {
          ...
          if (Qt(d)) i[d] = p;
            ...
            var v = pn[d],
              h = Yt(p, v);
            if (Bt.has(d)) {
              if (((s = !0), (o[d] = h), l.push(d), !f)) continue;
              p !== (v.default || 0) && (f = !1);
            } else d.startsWith("origin") ? ((c = !0), (u[d] = h)) : (a[d] = h);
          }
        }
        if (
          (t.transform ||
            ...
            (function (e, n, r) {
              ...
              return (0, t.useMemo)(
                function () {
                  ...
                  return (
                    vn(e, n, { enableHardwareAcceleration: !r }, a),
              ...
              f(),
                u.current ||
                  ...
                  (s.current = fr(
                    ...
                    er(window, "pointercancel", v, c)
                  )),
                  o.animationState && o.animationState.setActive(qn.Tap, !0),
                  r && r(e, t));
            }
            tr(o, "pointerdown", l ? h : void 0, c), sr(f);
          }),
          focus: Sr(function (e) {
            var t = e.whileFocus,
              n = e.visualElement,
        ...
        function A() {
          j++,
            "reverse" === v
              ...
              : ((c = xi(c, R, m)), "mirror" === v && D.flipTarget()),
            (L = !1),
            S && S();
        }
        function V(e) {
      ...
      function Ti(e, t, n) {
        ...
        if (
          ...
          for (
            var d = ki(i), p = { done: !1, value: o[0] }, v = [], h = 0;
            !p.done;
      ...
      function Li(e) {
        ...
        function P(e) {
          C(ct({ type: "spring", stiffness: d, damping: v, restDelta: m }, e));
        }
      ...
      var Xi = new Set(["opacity"]),
        Ki = function (e, t, n) {
          ...
          return function (a) {
            ...
            if (!d || !p || Oa || !1 === i.type) return Ri(v);
            if ("inertia" === i.type) {
              var h = Li(v);
              return function () {
                return h.stop();
            ...
            Ii(i) || (v = ct(ct({}, v), Ai(e, v))),
              v.duration && (v.duration = La(v.duration)),
              v.repeatDelay && (v.repeatDelay = La(v.repeatDelay));
            var m = t.owner,
              y = m && m.current;
            if (
              qi.waapi() &&
      ...
      function Ji(e, t) {
        ...
        var v = [],
          ...
          m = function (t) {
            var n = e.getValue(t),
              r = d[t];
            if (!n || void 0 === r || (h && no(h, t))) return "continue";
            ...
            var l = e.getProps(),
              ...
              v = function () {
                var t = io[h],
                  ...
                  y = bt(m),
                  g = t === o ? v.isActive : null;
                !1 === g && (p = h);
                var b = m === u[t] && m !== l[t] && y;
                if (
                  (b && r && e.manuallyAnimateOnMount && (b = !1),
                  (v.protectedKeys = ct({}, d)),
                  (!v.isActive && null === g) ||
                    (!m && !v.prevProp) ||
                    xt(m) ||
                    "boolean" === typeof m)
                ...
                var E = v.prevResolvedValues,
                  ...
                  P = ct(ct({}, C), S),
                  T = function (e) {
                    (w = !0), c.delete(e), (v.needsAnimating[e] = !0);
                  };
                for (var j in P) {
                  var R = S[j],
                    L = C[j];
        ...
        function e(t, n) {
          ...
          if (
            ...
            (this.handlePointerMove = function (e, t) {
              Gn(e) &&
                ((r.lastMoveEvent = e),
                (r.lastMoveEventInfo = ho(t, r.transformPagePoint)),
            ...
            (this.handlePointerUp = function (e, t) {
              if (Gn(e)) {
                ...
                var n = r.handlers,
                  a = n.onEnd,
                  i = n.onSessionEnd,
                  o = yo(ho(t, r.transformPagePoint), r.history);
            ...
            var o = Zn(t),
              l = ho(o, this.transformPagePoint),
              u = l.point,
              s = jr.timestamp;
        ...
        pan: Sr(function (e) {
          ...
          (0, t.useEffect)(function () {
            ...
            tr(
              ...
              l &&
                function (e) {
                  u.current = new vo(e, c, { transformPagePoint: s });
                }
            ),
            sr(function () {
          ...
          ? (function (e, t) {
              ...
              if (
                ...
                return (
                  ...
                  e.render(),
                  vt && null !== u && window.scrollTo({ top: u }),
      ...
      var kl = ["willChange"],
        ...
        Pl = (function () {
          function e(t) {
            ...
            for (var v in p) {
              var h = p[v];
              void 0 !== u[v] && Ht(h) && (h.set(u[v], !1), Ta(f) && f.add(v));
            }
          }
          return (
            m(e, [
                  ...
                  zt))
                    if (void 0 !== u[d]) {
                      var p = zt[d],
                        ...
                        m = v(u[d], o);
                      if (h)
                        for (var y = h.length, g = 0; g < y; g++) a[h[g]] = m;
                      else a[d] = m;
                    }
                  return (
                    this.options.layoutId &&
      ...
      var Uu = function () {
        ...
        $u = [
          ...
          },
          {
            id: 3,
            title: "Fetch Anime",
            date: "F\xe9vrier 2023",
            languages: ["React", "Rest api", "Mat\xe9rial UI"],
            infos:
              "Fetch Anime est une plateforme de streaming et tracking d\xe9di\xe9e aux anime. Elle offre une large s\xe9lection d'anim\xe9 et permet aux utilisateurs de cr\xe9er des liste de planning,de souhait et d'anim\xe9 d\xe9ja vu afin de pouvoir suivre leur anim\xe9.",
            img: "./assets/img/projet-3.png",
            link: "https://fetch-anime-wcs.netlify.app/",
          },
          {
            id: 4,
            title: "Origins digitals",
            date: "Octobre 2024",
            languages: ["React", "React Native", "Express", "Sass", "MySql"],
            infos:
              "Origins Digital est une plateforme d'h\xe9bergement vid\xe9o qui propose un service de streaming vid\xe9o gratuit sans n\xe9cessit\xe9 d'un acc\xe8s payant. La plateforme offre plusieurs cat\xe9gories de jeux Esport, et est g\xe9r\xe9e par des administrateurs. Les utilisateurs peuvent cr\xe9er un compte sur la plateforme, ajouter des vid\xe9os \xe0 leurs favoris, ainsi que commenter les vid\xe9os. Le site est optimis\xe9 pour une utilisation mobile-first pour garantir une exp\xe9rience utilisateur optimale. L'interface d'administration permet aux administrateurs de g\xe9rer les vid\xe9os, les cat\xe9gories, les utilisateurs",
          ...
          return (0, Qe.jsx)("main", {
            children: (0, Qe.jsxs)("div", {
              ...
              children: [
                ...
                (0, Qe.jsx)(it, { left: "/projet-2", right: "/projet-4" }),
              ],
            }),
          });
        },
          ...
          return (0, Qe.jsx)("main", {
            children: (0, Qe.jsxs)("div", {
              ...
              children: [
                ...
                (0, Qe.jsx)(Xe, {}),
                (0, Qe.jsx)(Ke, {}),
                (0, Qe.jsx)(qu, { projectNumber: 3 }),
                (0, Qe.jsx)(it, { left: "/projet-3", right: "/contact" }),
              ],
            }),
          });
        };
      ...
      var es = function (e) {
        ...
        return (
          ...
          "popLayout" === u && (n = t.createElement(Ju, { isPresent: a }, n)),
      ...
      var rs = function (e) {
          ...
          b = f(b);
          for (
            var E = w.current.map(ns), C = g.map(ns), P = E.length, T = 0;
            T < P;
            T++
          ) {
            var j = E[T];
      ...
      a.createRoot(document.getElementById("root")).render((0, Qe.jsx)(as, {}));
    })();
})();
//# sourceMappingURL=main.49d30e6f.js.map
